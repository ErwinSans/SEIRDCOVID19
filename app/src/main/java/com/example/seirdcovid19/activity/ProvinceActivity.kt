...
import com.example.seirdcovid19.adapter.ProvinceAdapter
import com.example.seirdcovid19.api.RetrofitClient
import com.example.seirdcovid19.model.ProvinceResponse
import kotlinx.android.synthetic.main.activity_province2.*
...
class ProvinceActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_province2)
        showProvince()
    }
